...
h=Hoe.spec('statsample') do
  ...
  #self.testlib=:minitest
	...
	self.extra_deps << ["spreadsheet","~>0.6.5"] << ["minimization", "~>0.2.0"] << ["fastercsv", ">0"] << ["dirty-memoize", "~>0.0"] << ["extendmatrix","~>0.3.1"] << ["statsample-bivariate-extension", ">0"] << ["rserve-client", "~>0.2.5"] << ["rubyvis", "~>0.5"] << ["distribution", "~>0.6"]
